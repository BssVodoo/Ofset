...
namespace NZF_DAL
{
    ...
    public class Kullanici : DataAccesBase
    {
        ...
        public Kullanici (int pID)
        {
            m_SQL = "Select * from Kullanici where ID=" + pID;
            initialize();
        }

        public Kullanici(string pFIELD_NAME, string pVALUE)
        {
            m_SQL = "Select * from Kullanici where " + pFIELD_NAME + "='" + pVALUE + "'";
            initialize();
        }
       ...
       public void Kaydet()
		...
		private int KaydetInsert()
        {
			...
			SQL="Insert Into Kullanici (Eposta, Sifre) values (";
            SQL += "'" + Eposta + "',";
            SQL += "'" + Sifre + "'  ";
       ...
       public object Delete()
        {
            m_SQL = "Delete from Kullanici where ID=" + m_ID;
